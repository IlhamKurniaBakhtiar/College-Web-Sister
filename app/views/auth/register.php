...
<div class="flex items-center justify-center min-h-screen bg-stone-100">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 class="text-2xl font-bold text-stone-800 mb-6 text-center">Register</h2>
        ...
        <form method="post" class="space-y-4">
            ...
            <div>
                <label class="block text-stone-700 mb-1">Email</label>
        ...
        <p class="mt-4 text-center text-sm text-stone-600">
            Sudah punya akun?
            <a href="/College-Web-Sister/public/auth/login" class="text-indigo-600 hover:underline">Login</a>
        </p>
    </div>
</div>
