                ...
                <?php foreach ($dosen_list as $dosen): ?>
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="py-4 px-6 text-center">
                            <a href="/College-Web-Sister/public/dosen/edit/<?= $dosen['NIP'] ?>" class="bg-gray-600 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded-lg transition duration-300 text-sm">Edit</a>
