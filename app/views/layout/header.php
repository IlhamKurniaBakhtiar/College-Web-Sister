    ...
    <nav class="bg-gray-800 shadow-lg sticky top-0 z-50">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-2">
                    <a href="/College-Web-Sister/public/mahasiswa" class="group relative flex items-center justify-center text-gray-300 hover:bg-gray-700 hover:text-white h-12 w-12 rounded-full transition-colors duration-200">
                        ...
                        <span class="absolute top-full mt-2 whitespace-nowrap bg-gray-900 text-white text-xs px-2 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                            Mahasiswa
                        </span>
                    </a>
                ...
                <div class="md:hidden flex items-center">
                    <button id="hamburger-button" class="text-gray-300 hover:text-white focus:outline-none">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div id="mobile-menu" class="md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <?php if (isset($_SESSION['user'])): ?>
                    <a href="/College-Web-Sister/public/auth/profile" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
