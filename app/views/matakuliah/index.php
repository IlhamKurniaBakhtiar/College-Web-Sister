...
<div class="bg-white p-8 rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="/College-Web-Sister/public/matakuliah/create" class="bg-gray-700 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded-lg transition duration-300">
            + Tambah Matkul
        </a>
    </div>
                ...
                <?php foreach ($matkul_list as $matkul): ?>
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="py-4 px-6 text-center">
                            <a href="/College-Web-Sister/public/matakuliah/edit/<?= $matkul['KodeMatkul'] ?>" class="bg-gray-600 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded-lg transition duration-300 text-sm">Edit</a>
                            <a href="/College-Web-Sister/public/matakuliah/delete/<?= $matkul['KodeMatkul'] ?>" class="bg-red-600 hover:bg-reed-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300 text-sm" onclick="return confirm('Yakin ingin hapus?')">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
